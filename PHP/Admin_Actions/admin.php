...
<head>
    ...
    <link rel="stylesheet" href="../../STYLE/admin_admin.css">
...
<body>
    ...
    <div id="body">
        ...
        <center id="content">
            <h1 style="font-size: 5vw;">Admin Actions</h1>
            <ul>
                <li class="menu_options" id="admin_add_admin"><a href="./admin_actions/add_admin.php">Add Admin</a></li>
                <li class="menu_options" id="admin_remove_admin"><a href="./admin_actions/remove_admin.php">Remove Admin</a></li>
                <li class="menu_options" id="admin_change_admin_info"><a href="./admin_actions/change_admin_info.php">Change Admin Info</a></li>
            </ul>
        </center>
    </div>
</body>
