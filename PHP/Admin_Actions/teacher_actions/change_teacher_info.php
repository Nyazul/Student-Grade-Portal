...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["submit"])) {
    ...
    if ($result1) {
        ...
        if (!empty($row1)) {
            ...
            $_SESSION["targettype"] = strval("teacher");
            header("Location: ../changing_target_info.php");
            exit();
        } else {
            header("Location: ./change_teacher_info.php?DoesNotExist=true");
            exit();
        }
    } else {
...
<head>
    <title>Change Teacher Info</title>
    ...
    <div id="body">
        ...
        <center>
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <input type="text" name="id" id="id" pattern="6[0-9]{4}" required>
